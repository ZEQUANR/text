...
func (m *NodeMutation) SetSsssss(i int) {
	m.parent = &i
}

// Ssssss returns the value of the "ssssss" field in the mutation.
func (m *NodeMutation) Ssssss() (r int, exists bool) {
	v := m.parent
	if v == nil {
		return
	}
...
// OldSsssss returns the old "ssssss" field's value of the Node entity.
// If the Node object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *NodeMutation) OldSsssss(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSsssss is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldSsssss requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldSsssss: %w", err)
	}
	return oldValue.Ssssss, nil
}

// ClearSsssss clears the value of the "ssssss" field.
func (m *NodeMutation) ClearSsssss() {
	m.parent = nil
	m.clearedFields[node.FieldSsssss] = struct{}{}
}

// SsssssCleared returns if the "ssssss" field was cleared in this mutation.
func (m *NodeMutation) SsssssCleared() bool {
	_, ok := m.clearedFields[node.FieldSsssss]
	return ok
}

// ResetSsssss resets all changes to the "ssssss" field.
func (m *NodeMutation) ResetSsssss() {
	m.parent = nil
	delete(m.clearedFields, node.FieldSsssss)
}
...
func (m *NodeMutation) ParentCleared() bool {
	return m.SsssssCleared() || m.clearedparent
}
...
func (m *NodeMutation) Fields() []string {
	...
	if m.parent != nil {
		fields = append(fields, node.FieldSsssss)
	}
	return fields
}
...
func (m *NodeMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(node.FieldSsssss) {
		fields = append(fields, node.FieldSsssss)
	}
	return fields
}
